...
@Component({
  selector: 'app-betgame-bettinghistory',
  templateUrl: './betgame-bettinghistory.component.html',
  styleUrls: ['./betgame-bettinghistory.component.scss']
})
export class BetgameBettinghistoryComponent implements OnInit {
  ...
  GetBetHistory() {
    ...
    this.reportsService.casinoBGBetsHistory(
