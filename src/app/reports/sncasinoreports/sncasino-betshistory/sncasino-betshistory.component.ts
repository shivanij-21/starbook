...
@Component({
  selector: 'app-sncasino-betshistory',
  templateUrl: './sncasino-betshistory.component.html',
  styleUrls: ['./sncasino-betshistory.component.scss']
})
export class SncasinoBetshistoryComponent implements OnInit {
  ...
  GetBetHistory() {
    ...
    this.reportsService.SNCasinoBetHistory(
