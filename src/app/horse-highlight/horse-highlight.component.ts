...
@Component({
  selector: 'app-horse-highlight',
  templateUrl: './horse-highlight.component.html',
  styleUrls: ['./horse-highlight.component.scss']
})
export class HorseHighlightComponent implements OnInit {
